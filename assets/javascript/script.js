...
function getPasswordOptions() {
  ...
  pwdLength = prompt(
    "Please specify the length of your password - enter a number between 8 and 128."
  );
  ...
  if (pwdLength < 8 || pwdLength > 128) {
    ...
    lowerCase = confirm(
      "Would you like your new password to include lowercase characters?"
    );
    upperCase = confirm(
      "Would you like your new password to include uppercase characters?"
    );
    numbers = confirm("Would you like your new password to include numbers?");
    specialChar = confirm(
      "Would you like your new password to include special characters?"
    );
